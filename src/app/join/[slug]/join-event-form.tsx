...
export default function JoinEventForm({
  ...
  event: { id: string; name: string; description: string | null; day_of_week: number; frequency: string };
}) {
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            {showOtp
              ...
              : `${DAY_NAMES[event.day_of_week]}s \u2022 ${event.frequency.charAt(0).toUpperCase() + event.frequency.slice(1)}`}
          </p>
          {!showOtp && event.description && (
          ...
          <form action={joinAction} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="1234567"
              />
              <p className="mt-1 text-xs text-gray-400">Your USGA Golf Handicap ID</p>
            </div>
